...
class ShiftReqMultiFilter extends StatefulWidget {
  const ShiftReqMultiFilter({super.key});

  @override
  State<ShiftReqMultiFilter> createState() => _ShiftReqMultiFilterState();
}

class _ShiftReqMultiFilterState extends State<ShiftReqMultiFilter>
  ...
  // Get the ShiftRequestViewController instance
  final ShiftRequestViewController controller = Get.find<ShiftRequestViewController>();
  ...
  Widget _buildStatusItem(
    ...
    final isSelected = controller.selectedStatus.value.toLowerCase() == statusCode.toLowerCase();
